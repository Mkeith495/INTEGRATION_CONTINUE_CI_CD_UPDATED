...
(0, globals_1.describe)('US-1 : Créer un produit - E2E', function () {
    ...
    (0, globals_1.test)('Scénario 5: création échouée, titre supérieur à 20 caractères', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, products;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    response = _a.sent();
                    (0, globals_1.expect)(response.status).toBe(400);
                    (0, globals_1.expect)(response.body.message).toBe('titre trop long');
                    return [4 /*yield*/, dataSource.getRepository(Product_1.Product).find()];
                case 3:
                    products = _a.sent();
                    (0, globals_1.expect)(products).toHaveLength(0);
    ...
    (0, globals_1.test)('Scénario 6: création échouée, espace dans le titre', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, products;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dataSource.getRepository(Product_1.Product).clear()];
                ...
                case 3:
                    ...
                    (0, globals_1.expect)(response.status).toBe(400);
                    (0, globals_1.expect)(response.body.message).toBe("erreur, le titre ne doit pas contenir d'espace");
                    return [2 /*return*/];
            }
        });
    }); });
